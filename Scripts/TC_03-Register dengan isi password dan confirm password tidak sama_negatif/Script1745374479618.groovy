...
WebUI.setText(findTestObject('Page_ParaBank  Register for Free Online Account Access/input_Confirm'), 'test12345')

WebUI.click(findTestObject('Page_ParaBank  Register for Free Online Account Access/button_Register'))

WebUI.waitForPageLoad(30)

WebUI.scrollToElement(findTestObject('Page_ParaBank  Register for Free Online Account Access/button_Register'), 0)

WebUI.delay(5)

WebUI.verifyTextPresent('Passwords did not match.', false)
