...
WebUI.setText(findTestObject('Page_ParaBank  Welcome  Online Banking/input_Username_login'), '')

WebUI.click(findTestObject('Page_ParaBank  Welcome  Online Banking/input_Password_login'))

WebUI.setText(findTestObject('Page_ParaBank  Welcome  Online Banking/input_Password_login'), '')

WebUI.click(findTestObject('Page_ParaBank  Welcome  Online Banking/button_Login'))

WebUI.delay(5)

WebUI.verifyTextPresent('Please enter a username and password.', false)
